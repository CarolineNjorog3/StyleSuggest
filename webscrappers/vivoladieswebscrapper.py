...
def download_image(url, folder="VivoLadies"):
...
def scrape_images(base_url, pages=10):
    ...
    for page in range(1, pages + 1):
        ...
        if response.status_code == 200:
            ...
            divs = soup.find_all('div', class_='collection-content')
